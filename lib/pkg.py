...
class Pkg:
	...
	def install(self, pkgs):
		...
		self.pkg_process_loop() # Verificar se existe outro processo 'apt' em execução no sistema.

		for APP in pkgs: # Instalar cada pacote da lista, individualmente.
			print(line)
			print(f'Instalando: {APP}')			
			print(line)
			os.system(f'sudo pkg install {APP}')
